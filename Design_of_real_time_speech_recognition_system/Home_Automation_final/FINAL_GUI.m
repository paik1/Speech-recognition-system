...
% Last Modified by GUIDE v2.5 12-Apr-2017 14:40:19
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
handles.Time=6; % the audio recording time
handles.Fs = 16000;% sampling frequency
  disp('start recording');
  recobj=audiorecorder(16000,16,1);
  recobj.recordblocking(handles.Time);
   disp('stop recording');
    handles.y = getaudiodata(recobj);
