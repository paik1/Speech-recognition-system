...
w=1;
 ...
 dotproduct=(((fftypre2 .* conjugatemat)/Nfft));%power calculation
 
 %%%%%%construction of mel filterbank%%%%%
f_min=0;
fs=16000;
fnumber=26;
f_low=300;
...
% Mel filter output is Generated  
...
%**********************sorting to find top 10 power peaks ************************************************
...
%%%%calculation of Euclidean distance%%%%
 load refmat.mat;% it is matrix which contains 10 samples of each digit 
 % we have made all the samples uniform  frame size i.e 50 
